package site.binghai.SuperBigDumpling.impls;
...
import site.binghai.SuperBigDumpling.facades.PaymentPo;
...
import site.binghai.SuperBigDumpling.utils.MessageUtil;
import site.binghai.SuperBigDumpling.utils.WxPayUtil;
...
public class WxPayServiceImpl implements WxPayApi, InitializingBean {
    ...
    private JSONObject getWxPayInfo(PaymentPo paymentPo) throws DocumentException {
        ...
        String key = "&key=" + wxParams.getPaySecret(); // 商户支付密钥
        //MD5运算生成签名
        ...
        if (return_code == "SUCCESS" || return_code.equals(return_code)) {
            ...
            //再次签名
            String paySign = WxPayUtil.sign(stringSignTemp, "&key=" + wxParams.getSecret(), "utf-8").toUpperCase();
